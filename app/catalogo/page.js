            ...
            {!success ? (
              ...
              <div style={s.successScreen}>
                ...
                >
                  ...
                  {codeCopied && (
                    <span className="copied-overlay" style={{position: 'absolute', inset: 0, background: 'rgba(45,107,228,0.6)', backdropFilter: 'blur(2px)', WebkitBackdropFilter: 'blur(2px)', color: 'white', textShadow: '0 1px 3px rgba(0,0,0,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, fontSize: 14, fontWeight: 800, borderRadius: 8, pointerEvents: 'none'}}>
