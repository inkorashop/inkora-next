...
const styles = {
  ...
  filterBtn: { background: 'white', border: '1.5px solid #c8d0e8', color: '#5a6380', borderRadius: 20, padding: '6px 16px', fontSize: 13, fontWeight: 600, cursor: 'pointer', boxShadow: '0 1px 4px rgba(27,47,94,0.08)' },
  filterActive: { background: '#1B2F5E', borderColor: '#1B2F5E', color: 'white', boxShadow: '0 2px 8px rgba(27,47,94,0.25)' },
