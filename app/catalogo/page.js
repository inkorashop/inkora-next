            ...
            {!success ? (
              ...
              <div style={s.successScreen}>
                ...
                <div
                  ...
                  style={{...s.successCode, display: 'inline-block', position: 'relative', cursor: 'pointer', borderRadius: 8, padding: '2px 32px 2px 10px', transition: 'background 0.2s', background: codeCopied ? '#dcfce7' : 'transparent'}}
                >
                  ...
                  <span style={{position: 'absolute', top: '50%', right: 8, transform: 'translateY(-50%)', display: 'flex', opacity: codeCopied ? 1 : 0.4, color: codeCopied ? '#15803d' : s.successCode.color, transition: 'opacity 0.2s ease, color 0.2s ease'}}>
                    {codeCopied ? (
                      ...
                      <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="8" y="2" width="8" height="4" rx="1" ry="1" /><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /></svg>
                    )}
                  </span>
                  {codeCopied && (
                    ...
                    <div style={{marginTop:22, borderTop:'1.5px solid #eef0f6', paddingTop:18, textAlign:'left'}}>
                      <div style={{background:'#f8fdf9', border:'1.5px solid #c7f4d8', borderRadius:12, padding:14}}>
                        ...
                        >
                          ...
                          <span style={{position:'absolute', top:10, right:10, display:'flex', opacity: waCopied ? 1 : 0.4, color: waCopied ? '#15803d' : '#18a36a', transition:'opacity 0.2s ease, color 0.2s ease'}}>
                            {waCopied ? (
                              <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                            ) : (
                              <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="8" y="2" width="8" height="4" rx="1" ry="1" /><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /></svg>
